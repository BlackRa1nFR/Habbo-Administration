...
<html lang="en" ng-app="roleplayWebsite">
	<head>
		<base href="/">
		<title><?php echo e($website); ?> - Login or Join Today!</title>
		<meta charset="utf-8">
    ...
    <header>
      ...
      <div id="border-right"></div>
			<?php if(Session::has('message')): ?>
				<div id="login-errors"><?php echo e(Session::get('message')); ?></div>
			<?php endif; ?>
      <div id="login-form-container">
        ...
        <form method="post" style="transition: all 950ms ease-in-out; opacity: 1;">
          ...
          <div id="login-column-4">
              <font style="font-size:15.3px;"><b><?php echo e($online); ?></b> User(s) Online!</font>
          </div>
        </div>
      </div>
      ...
      <ul>
        <li id="home-anchor" class="home-anchor-day" >
          <div id="welcome">
            ...
            <div id="slogan">
              <h1>Welcome to <?php echo e($website); ?>,</h1>
